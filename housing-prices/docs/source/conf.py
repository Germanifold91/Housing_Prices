...
# housing_prices documentation build
...
from housing_prices import __version__ as release

# -- Project information -----------------------------------------------------

project = "housing_prices"
author = "Kedro"
...
texinfo_documents = [
    (
        ...
        author,
        "housing_prices",
        "Project housing_prices codebase.",
        "Data-Science",
    )
]
